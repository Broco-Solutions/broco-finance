...
export function ExpenseList({ initial, categories: cats, projects: projs }: { initial: E[]; categories: Cat[]; projects: Proj[] }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Pay modal */}
      {payTarget && <ModalPortal><div className="fixed inset-0 z-[90] overflow-y-auto"><button className="fixed inset-0 bg-black/50" onClick={() => setPayTarget(null)} /><div className="flex min-h-full items-center justify-center p-4"><div className="w-full max-w-sm rounded-xl bg-white p-5 shadow-xl"><h2 className="text-lg font-bold">Pagar</h2><p className="text-sm text-gray-500 mt-1">{payTarget.concept}</p>
      ...
      {/* Category management */}
      {showCatMgmt && <ModalPortal><div className="fixed inset-0 z-[90] overflow-y-auto"><button className="fixed inset-0 bg-black/50" onClick={() => setShowCatMgmt(false)} /><div className="flex min-h-full items-center justify-center p-4"><div className="w-full max-w-sm rounded-xl bg-white p-5 shadow-xl"><h2 className="text-lg font-bold">Categorias</h2>
